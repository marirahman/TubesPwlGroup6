        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-blue-500 dark:bg-blue-700 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h1 class="mb-6 text-xl font-bold text-white">Edit Product</h1>
                    ...
                    <form action="{{ route('products.update', $product->id) }}" method="POST" class="space-y-6">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="w-2/3">
                                <input type="text" id="code" name="code" value="{{ old('code', $product->code) }}" required
                                    class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-blue-800 text-gray-900 dark:text-gray-100 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        </div>
                        ...
                        <div class="flex justify-end space-x-4">
                            ...
                            <a href="{{ route('products.index') }}" class="px-6 py-3 bg-gray-500 text-white rounded-md hover:bg-gray-600">
                                Cancel
                            </a>
                        </div>
                    </form>
