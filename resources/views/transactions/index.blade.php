        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-blue-500 text-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <a href="{{ route('transactions.create') }}" class="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-blue-700 mb-4 inline-block">Add New Transaction</a>
                                    ...
                                    <tr class="bg-white dark:bg-gray-700 border-b border-gray-300 dark:border-gray-600">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex space-x-2">
                                                ...
                                                <a href="{{ route('transactions.show', $transaction->id) }}" class="px-3 py-1 bg-blue-600 text-white rounded-md hover:bg-blue-700 text-sm">View</a>
                                                <form action="{{ route('transactions.destroy', $transaction->id) }}" method="POST" onsubmit="return confirm('Are you sure?')">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="px-3 py-1 bg-blue-600 text-white rounded-md hover:bg-blue-700 text-sm">Delete</button>
                                                </form>
                                            </div>
                                        </td>
                                    </tr>
